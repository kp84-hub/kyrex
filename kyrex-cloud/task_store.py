    ...
    def request_cancel(self, task_id: str) -> bool:
        ...
        with self._lock:
            ...
            if status == STATUS_QUEUED:
                ...
                self._conn.commit()
                self.add_event(task_id, "cancelled", {"reason": "queued cancel"})
                return True
            ...
            self._conn.commit()
            self.add_event(task_id, "cancel_requested", {})
            return True
...
class TaskWorker:
    ...
    The worker:
      ...
      * loops: recover stale tasks, claim the next one, execute it inline;
