...
# Test 5
print("Test 5: executor exits while approval pending — lock still released")
sent.clear()
tb.pending_approvals.clear()
...
# Test 6
print("Test 6: bare 'y' (no reply-to) must not be launched as a git task")
...
# Test 7
print("Test 7: reply arriving after timeout must not be launched as a task")
sent.clear()
launched.clear()
tb.pending_approvals.clear()
...
print("\n" + ("TESTS 5-7 PASSED" if not failures
