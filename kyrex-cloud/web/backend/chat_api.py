...
# capability (chief-of-staff / calendar / calendar-editor / developer / browser)
# and the server
...
async def change_bot_capability(bot_id: str, request: Request):
    ...
    Body: ``{"capability": "chief-of-staff" | "calendar" | "calendar-editor" |
    "developer" | "browser"}``. The bot's policy is replaced by the server-side capability
